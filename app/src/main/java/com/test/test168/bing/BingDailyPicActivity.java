...
public class BingDailyPicActivity extends BaseActivity {
    ...
    protected void initViews() {
        ...
        setContentView(R.layout.activity_bing_daily_pic);
...
//        getMenuInflater().inflate(R.menu.menu_bing_daily_pic, menu);
        return true;
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return BingDailyPictureFragment.newInstance(position + 1);
        }
