package com.test.test168.utils.rxphoto;
...
import static com.test.test168.utils.rxphoto.RxFileTool.getDataColumn;
import static com.test.test168.utils.rxphoto.RxFileTool.isDownloadsDocument;
import static com.test.test168.utils.rxphoto.RxFileTool.isExternalStorageDocument;
import static com.test.test168.utils.rxphoto.RxFileTool.isGooglePhotosUri;
import static com.test.test168.utils.rxphoto.RxFileTool.isMediaDocument;

/**
 * @author vondear
 * @date 2016/1/24
 * 根本 就 不 是 用 rxjava 封装的！！！！！
 * 垃圾东西！浪费我时间
 */
