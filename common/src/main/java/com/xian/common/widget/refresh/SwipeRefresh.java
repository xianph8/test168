package com.xian.common.widget.refresh;
 ...
 * </p>
 */
class SwipeRefresh extends ViewGroup {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mActivePointerId == INVALID_POINTER) {
                    XLog.e("Got ACTION_MOVE event but don't have an active pointer id.");
                    return false;
                }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (pointerIndex < 0) {
                    XLog.e("Got ACTION_MOVE event but have an invalid active pointer id.");
                    return false;
                }
            ...
            case MotionEvent.ACTION_CANCEL: {
                if (mActivePointerId == INVALID_POINTER) {
                    if (action == MotionEvent.ACTION_UP) {
                        XLog.e("Got ACTION_UP event but don't have an active pointer id.");
                    }
                    return false;
                }
                final int pointerIndex = MotionEventCompat.findPointerIndex(ev, mActivePointerId);
